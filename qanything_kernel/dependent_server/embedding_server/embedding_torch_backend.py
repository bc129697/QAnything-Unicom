...
from qanything_kernel.configs.model_config import LOCAL_TORCH_EMBED_PATH
import torch
...
class EmbeddingTorchBackend(EmbeddingBackend):
    def __init__(self, device: str = "cpu"):
        ...
        self.device = device
        self._model = AutoModel.from_pretrained(LOCAL_TORCH_EMBED_PATH, return_dict=False)
        ...
        debug_logger.info(f"embedding device: {self.device}")
