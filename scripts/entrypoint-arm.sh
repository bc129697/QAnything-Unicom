...
nohup python3 -u qanything_kernel/dependent_server/rerank_server/rerank_server.py --devices npu:0 > /workspace/QAnything/logs/debug_logs/rerank_server.log 2>&1 &
PID1=$!
nohup python3 -u qanything_kernel/dependent_server/embedding_server/embedding_server.py --devices npu:0 > /workspace/QAnything/logs/debug_logs/embedding_server.log 2>&1 &
PID2=$!
